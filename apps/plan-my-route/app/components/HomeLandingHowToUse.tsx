...
function ScreenshotPlaceholder({ step, src, alt }: ScreenshotPlaceholderProps) {
	...
	return (
		...
		>
			...
			<span className="text-xs tracking-wide text-[#94A3B8]">스크린샷 준비 중</span>
		</div>
	);
}
	...
	return (
		<section className="bg-[#F8FAFC] px-6 py-20">
			<div className="mx-auto max-w-5xl">
				<p className="mb-2 text-center text-sm tracking-wide text-[#5842F4]">HOW TO USE</p>
				<h2 className="mb-4 text-center text-2xl text-[#020817] md:text-3xl">사용 방법</h2>
				<p className="mb-20 text-center text-sm text-[#94A3B8]">
					스크롤하며 단계별로 살펴보세요
				</p>
						...
						return (
							...
							>
								<div>
									...
									<h3 className="mb-3 text-xl text-[#020817]">{step.title}</h3>
